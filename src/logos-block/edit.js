			...
			<div className={`logos-block__container ${containerMode === "constrained" ? "is-constrained" : ""}`}>
				...
				>
					{partnerLogos.length > 0 ? (
						...
						>
							{__("Partner Logos Slider Preview", "logos-block")} •{" "}
							{__("Edit in sidebar →", "logos-block")}
						</div>
						...
						>
							...
							{__("Speed", "logos-block")}: {sliderSpeed} •
							{__("Desktop", "logos-block")}: {slidesPerView} •
							{__("Tablet", "logos-block")}: {Math.min(slidesPerView, 3)} •
							{__("Mobile", "logos-block")}: {Math.min(slidesPerView, 2)} •
							{__("iPhone", "logos-block")}: 1 •{__("Gap", "logos-block")}:{" "}
							{gap}
							<div style={{ marginTop: "4px", fontStyle: "italic" }}>
								{__(
									"📱 Fully responsive: Logos automatically resize and reduce on smaller screens",
									"logos-block",
								)}
							</div>
						</div>
