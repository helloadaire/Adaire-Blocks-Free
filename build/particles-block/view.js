...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (locoInstance) {
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__["default"].scrollerProxy(document.body, {
      scrollTop(value) {
        return arguments.length ? locoInstance.scrollTo(value, 0, 0) : locoInstance.scroll.instance.scroll.y;
      },
    ...
    locoInstance.on("scroll", gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__["default"].update);
  ...
  if (textSections.length > 1 && textOverlay) {
    ...
    textSections.forEach((section, index) => {
      ...
      if (index === 0) {
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(section, {
          opacity: 1,
          display: 'block'
        });
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set([title, desc], {
          opacity: 0,
          x: 100
        });
      } else {
      ...
      gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__["default"].create({
        ...
        onEnter: () => {
          ...
          textSections.forEach((other, i) => {
            if (i !== index) {
              gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(other, {
                display: 'none',
                opacity: 0
              });
              const oTitle = other.querySelector('h2');
              const oDesc = other.querySelector('p');
              gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set([oTitle, oDesc], {
                x: 100,
                opacity: 0
              });
            }
          ...
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to([title, desc], {
            x: 0,
            opacity: 1,
            duration: 0.35,
            stagger: 0.15,
      ...
      onLeave: () => {
        ...
        if (visibleSection) {
          ...
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to([title, desc], {
            ...
            ease: 'power2.in',
            onComplete: () => {
              gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(visibleSection, {
                display: 'none',
                opacity: 0
              });
              gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set([title, desc], {
  ...
  particles.forEach((particle, index) => {
    ...
    if (particleType === 'dynamic') {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(particle, {
        scale: 0.8
      });
      ...
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].fromTo(particle, {
        y: 0
      }, {
        y: `${-100 * speed}px`,
        ease: 'none',
