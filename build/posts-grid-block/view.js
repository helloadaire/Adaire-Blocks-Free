...
console.log('[Posts Grid Block] GSAP imported:', typeof gsap__WEBPACK_IMPORTED_MODULE_0__.gsap);
console.log('[Posts Grid Block] ScrollTrigger imported:', typeof gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  postsGridBlocks.forEach(postsGrid => {
    ...
    function filterPosts(filterValue) {
      ...
      const currentPostIds = grid ? Array.from(grid.children).map(child => parseInt(child.getAttribute('data-post-id'))) : [];
      if (filterValue === 'all') {
        filteredPosts = allPosts;
      } else {
        const categoryId = parseInt(filterValue);
        filteredPosts = allPosts.filter(post => post.categories && post.categories.includes(categoryId));
      }
    ...
    function renderPostsWithFLIP(currentPostIds, shouldScroll = true) {
      ...
      const elementsToRemove = allElements.filter(child => postsToRemove.includes(parseInt(child.getAttribute('data-post-id'))));

      // Fade out removing elements
      if (elementsToRemove.length > 0) {
        gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(elementsToRemove, {
          opacity: 0,
          scale: 0.8,
          duration: 0.2,
          stagger: 0.02,
      ...
      setTimeout(() => {
        ...
        postsToShow.forEach(post => {
          ...
          const existingElement = remainingElements.find(el => parseInt(el.getAttribute('data-post-id')) === post.id);
          if (existingElement) {
        ...
        if (newElements.length > 0) {
          gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(newElements, {
            opacity: 0,
            scale: 0.8
          }, {
            opacity: 1,
    ...
    function renderPosts(isInitialRender = false) {
      ...
      if (shouldAnimate) {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(grid.children, {
          ...exitAnimation,
          ...
          onComplete: () => {
            ...
            gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(grid.children, enterAnimation.from, {
              ...enterAnimation.to,
        ...
        if (hasExistingPosts && !isInitialRender) {
          gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(grid.children, {
            ...
            onComplete: () => {
              ...
              // Fade in new posts
              gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(grid.children, {
                opacity: 0
              }, {
                opacity: 1,
                duration: 0.2,
      ...
      if (layoutType === 'bento') {
        postHTML = `
                    <div class="adaire-posts-grid__image">
                        ${imageUrl ? `<img src="${imageUrl}" alt="${post.title.rendered}" loading="lazy" />` : `<div class="adaire-posts-grid__placeholder"><span>No Image</span></div>`}
    ...
    function createCategoriesHTML(categories) {
      ...
      const categoriesToShow = selectedCategories.length > 0 ? categories.filter(catId => selectedCategories.includes(catId)) : categories;
    ...
    function setupAnimations() {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(items, {
        opacity: 0,
      ...
      if (enableFiltering) {
        const filterButtons = postsGrid.querySelectorAll('.adaire-posts-grid__filter-btn');
        gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(filterButtons, {
          opacity: 0,
          y: -20
        }, {
          opacity: 1,
    ...
    function animateFilterTransition() {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(items, {
        ...
        onComplete: () => {
          ...
          gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(newItems, {
            opacity: 0,
            scale: 0.8
          }, {
            opacity: 1,
