...
/* harmony import */ var _splidejs_splide_extension_auto_scroll__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @splidejs/splide-extension-auto-scroll */ "./node_modules/@splidejs/splide-extension-auto-scroll/dist/js/splide-extension-auto-scroll.esm.js");
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  if (!_splidejs_splide__WEBPACK_IMPORTED_MODULE_2__["default"]) {
  ...
  sliderElements.forEach((splideElement, index) => {
    ...
    if (blockElement) {
      ...
      const splide = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_2__["default"](splideElement, {
        type: "loop",
        perPage: 3,
        perMove: 1,
        // Move only one slide at a time
        gap: 0,
        padding: 0,
        pagination: true,
        arrows: true,
      ...
      if (container && title && subtitle && carouselContainer) {
        // Enhanced entrance animations with ScrollTrigger
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set([title, subtitle, carouselContainer], {
          opacity: 0,
          y: 50
        });
        gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__["default"].create({
          ...
          start: "top 80%",
          onEnter: () => {
            gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to([title, subtitle, carouselContainer], {
              opacity: 1,
              y: 0,
        ...
        if (gradientGlow) {
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(gradientGlow, {
            scale: 0.8,
            opacity: 0.3
          });
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(gradientGlow, {
            scale: 1.2,
            opacity: 0.6,
        ...
        if (carouselContainer) {
          carouselContainer.addEventListener('mouseenter', () => {
            gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(carouselContainer, {
              scale: 1.02,
