...
gsap__WEBPACK_IMPORTED_MODULE_0__["default"].registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger, gsap_SplitText__WEBPACK_IMPORTED_MODULE_1__.SplitText);
...
function initPortfolioBlock(block) {
  ...
  function initGalleryAnimations() {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(".ad-portfolio-block__gallery-item", {
      y: 60,
      opacity: 0,
      scale: 0.95,
      transformOrigin: "center center"
    });
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(".ad-portfolio-block__gallery-overlay", {
      y: "100%",
      opacity: 0,
      pointerEvents: "none"
    });
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(".ad-portfolio-block__agency-description-text", {
      y: 30,
      opacity: 0
    });
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(".ad-portfolio-block__view-portfolio-btn", {
      y: 30,
      opacity: 0,
      scale: 0.9
    });
    ...
    const agencyTl = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
      scrollTrigger: {
    ...
    agencyTl.to(".ad-portfolio-block__agency-description-text", {
      y: 0,
      opacity: 1,
      duration: 1,
      stagger: 0.2,
    ...
    const galleryItems = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.toArray(".ad-portfolio-block__gallery-item");
    galleryItems.forEach((item, index) => {
      ...
      const itemTl = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
        scrollTrigger: {
          trigger: item,
          start: "top 85%",
          end: "bottom 15%",
      ...
      item.addEventListener("mouseenter", () => {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(overlay, {
          y: "0%",
          opacity: 1,
          duration: 0.3,
          ease: "power2.out",
    ...
    if (viewPortfolioBtn) {
      viewPortfolioBtn.addEventListener("mousemove", e => {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(viewPortfolioBtn, {
          x: x * 0.1,
          y: y * 0.1,
          duration: 0.3,
          ease: "power2.out"
  ...
  function openModal(startSlideIndex = 0) {
    ...
    if (modalOverlay) {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(modalOverlay, {
        opacity: 0
      });
      ...
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(modalOverlay, {
        opacity: 1,
        duration: 0.5,
        ease: "power2.inOut"
      });
  ...
  function createInitialSlide(startSlideIndex = 0) {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(slide, {
      y: "100vh",
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set([...words, ...lines], {
      y: "100%",
      opacity: 0,
      force3D: true
    });
    ...
    if (button) {
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(button, {
        y: 30,
        opacity: 0,
        scale: 0.9
      });
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(slide, {
      y: 0,
  ...
  function splitText(slide) {
    ...
    if (slideHeader) {
      gsap_SplitText__WEBPACK_IMPORTED_MODULE_1__.SplitText.create(slideHeader, {
        type: "words",
        wordsClass: "word",
        mask: "worrds"
      });
    ...
    slideContent.forEach(element => {
      gsap_SplitText__WEBPACK_IMPORTED_MODULE_1__.SplitText.create(element, {
        type: "lines",
        linesClass: "line",
        mask: "lines",
  ...
  function initModalAnimations() {
    ...
    function animateSlide(direction) {
      ...
      if (slideImg) {
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(slideImg, {
          scale: 1.5,
          duration: 2,
          ease: "power4.inOut",
          force3D: true
      ...
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(currentSlideElement, {
        scale: 0.25,
        opacity: 0,
        rotation: 30,
        y: exitY,
      ...
      setTimeout(() => {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(newSlide, {
          y: entryY,
        ...
        if (newSlideImg) {
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(newSlideImg, {
            scale: 1.5,
            force3D: true
          });
        }
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(newSlide, {
          y: 0,
          clipPath: "polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)",
          duration: 1.5,
          ease: "power4.inOut",
    ...
    if (modalContent) {
      ...
      // Wheel event
      modalContent.addEventListener("wheel", wheelHandler, {
        passive: false
      });
      eventListeners.push({
      ...
      // Touch events
      modalContent.addEventListener("touchstart", touchStartHandler, {
        passive: false
      });
      eventListeners.push({
        element: modalContent,
      ...
      modalContent.addEventListener("touchmove", touchMoveHandler, {
        passive: false
      });
      eventListeners.push({
        element: modalContent,
      ...
      modalContent.addEventListener("touchend", touchEndHandler, {
        passive: false
      });
      eventListeners.push({
        element: modalContent,
