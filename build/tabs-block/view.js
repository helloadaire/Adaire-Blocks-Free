...
document.addEventListener('DOMContentLoaded', function () {
  ...
  tabBlocks.forEach(tabBlock => {
    ...
    function updateUnderline(tabElement, immediate = false) {
      ...
      if (immediate) {
        gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(underline, {
          x: offsetLeft,
          y: offsetTop,
          width: width
        });
      } else {
        gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(underline, {
          x: offsetLeft,
          y: offsetTop,
          width: width,
          duration: duration,
      ...
      if (!immediate && oldPanel && oldPanel !== newPanel) {
        ...
        tl.to(oldPanel, {
          ...
          onComplete: () => {
            ...
            gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(oldPanel, {
              display: 'none',
              position: 'absolute',
              visibility: 'hidden',
              pointerEvents: 'none'
      ...
      if (!immediate) {
        ...
        if (panelContent) {
          ...
          if (children.length > 0) {
            gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(children, {
              opacity: 0,
              y: 30
            }, {
              opacity: 1,
