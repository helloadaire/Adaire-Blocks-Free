...
function resetIndexHighlight(index, currentDirection) {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].killTweensOf(highlight);
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(highlight, {
...
function animateIndexHighlight(index) {
  const highlight = document.querySelectorAll(".index .index-highlight")[index];
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(highlight, {
    width: "0%",
    scaleX: 1,
    transformOrigin: "right center"
  });
...
function animateNewImage(imgContainer, currentDirection) {
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(imgContainer, {
    clipPath: currentDirection === "next" ? "polygon(100% 0%, 100% 0%, 100% 100%, 100% 100%)" : "polygon(0% 0%, 0% 0%, 0% 100%, 0% 100%)"
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(imgContainer, {
...
function animateImageScale(currentImg, upcomingImg, currentDirection) {
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].fromTo(currentImg, {
    scale: 1,
    rotate: 0
  }, {
    scale: 1.3,
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].fromTo(upcomingImg, {
    scale: 1.3,
    rotate: currentDirection === "next" ? 4 : -4
  }, {
    scale: 1,
...
function changeStory(isAutomatic = true) {
  ...
  if (existingProfileText) {
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(existingProfileText, {
      opacity: 0,
      duration: 0.3,
      onComplete: () => {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(servicesContainer.querySelectorAll(".title-row h1"), {
  ...
  setTimeout(() => {
    ...
    story.title.forEach((line, index) => {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(newTitle, {
        y: 0,
        duration: 0.5,
        delay: contentUpdateDelay
      });
...
document.addEventListener("mousemove", event => {
  ...
  if (!isInside) {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(cursor, {
      opacity: 0,
      duration: 0.2
    });
    return;
