...
document.addEventListener("DOMContentLoaded", function () {
  document.querySelectorAll('.cgwego-html').forEach(blockRoot => {
    ...
    function createSplitText(element) {
      if (!split_type__WEBPACK_IMPORTED_MODULE_1__["default"]) return;

      // If the element has multiple paragraphs (from line splitting), handle each one
      const paragraphs = element.querySelectorAll('p');
      if (paragraphs.length > 1) {
        paragraphs.forEach(paragraph => {
          const splitText = new split_type__WEBPACK_IMPORTED_MODULE_1__["default"](paragraph, {
            types: "lines"
          });
          paragraph.innerHTML = "";
        ...
        const splitText = new split_type__WEBPACK_IMPORTED_MODULE_1__["default"](element, {
          types: "lines"
        });
        element.innerHTML = "";
        splitText.lines.forEach(line => {
    ...
    if (initialInfoText) {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].fromTo(lines, {
        y: 40,
        opacity: 0
      }, {
        y: 0,
    ...
    setTimeout(() => {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].fromTo(elementsToAnimate, {
        y: 40,
        opacity: 0
      }, {
        y: 0,
    ...
    function handleItemChange(index) {
      ...
      const elementsToAnimate = blockRoot.querySelectorAll(".title .cgwego-h1, .info .cgwego-p .line span, .credits .cgwego-p, .director .cgwego-p");
      ...
      if (gsap__WEBPACK_IMPORTED_MODULE_0__["default"]) {
        if (currentBlurryImg) {
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(currentBlurryImg, {
            opacity: 0,
            duration: 1,
            delay: 0.5,
            ease: "power2.inOut",
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(newBlurryImg, {
          delay: 0.5,
          opacity: 1,
          duration: 1,
          ease: "power2.inOut"
        });
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(elementsToAnimate, {
          y: -60,
          duration: 1,
          ease: "power4.in",
          stagger: 0.05
        ...
        if (currentReadMoreText) {
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(currentReadMoreText, {
            opacity: 0,
            duration: 1,
            ease: "power4.in",
            delay: 0.2
        ...
        if (currentProjectImgElem && currentProjectImg) {
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(currentProjectImgElem, {
            scale: 2,
            opacity: 0,
            duration: 1,
            ease: "power4.in"
          });
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(currentProjectImg, {
            scale: 0,
            bottom: "10em",
            duration: 1,
            ease: "power4.in",
            ...
            onComplete: () => {
              ...
              const {
                ...
                newReadMoreText,
                infoP
              } = createProjectDetails(activeItem, isLastItem);
              projectPreview.appendChild(newProjectDetails);
              projectPreview.appendChild(newProjectImg);
              createSplitText(infoP);
              const newElementsToAnimate = newProjectDetails.querySelectorAll(".title .cgwego-h1, .info .cgwego-p .line span, .credits .cgwego-p, .director .cgwego-p");
              gsap__WEBPACK_IMPORTED_MODULE_0__["default"].fromTo(newElementsToAnimate, {
                y: 40
              }, {
                y: 0,
                duration: 1,
              ...
              if (newReadMoreTextElement) {
                gsap__WEBPACK_IMPORTED_MODULE_0__["default"].fromTo(newReadMoreTextElement, {
                  opacity: 0
                }, {
                  opacity: 1,
                  duration: 0.8,
              ...
              gsap__WEBPACK_IMPORTED_MODULE_0__["default"].fromTo(newProjectImg, {
                scale: 0,
                bottom: "-10em"
              }, {
                scale: 1,
              ...
              gsap__WEBPACK_IMPORTED_MODULE_0__["default"].fromTo(newProjectImg.querySelector("img"), {
                scale: 2,
                opacity: 0
              }, {
                scale: 1,
          ...
          const {
            newProjectDetails,
            newProjectImg
          } = createProjectDetails(activeItem);
          projectPreview.appendChild(newProjectDetails);
          projectPreview.appendChild(newProjectImg);
          isAnimating = false;
        }
