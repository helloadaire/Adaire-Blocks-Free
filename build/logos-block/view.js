...
document.addEventListener("DOMContentLoaded", () => {
  ...
  sliderElements.forEach((splideElement, index) => {
    ...
    if (blockElement) {
      ...
      const splide = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"](splideElement, {
        type: "loop",
        ...
        breakpoints: {
          ...
          768: {
            perPage: Math.min(slidesPerView, 3),
            // Max 3 on tablet
            gap: '0.8rem'
          },
          640: {
            perPage: Math.min(slidesPerView, 2),
            // Max 2 on small tablet
            gap: '0.6rem'
          },
          480: {
            perPage: Math.min(slidesPerView, 2),
          ...
          375: {
            perPage: 1,
            // Only 1 on iPhone size
            gap: '0.3rem'
          },
          320: {
            perPage: 1,
            // Only 1 on very small screens
            gap: '0.2rem'
          }
        },
