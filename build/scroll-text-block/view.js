...
document.addEventListener("DOMContentLoaded", () => {
  ...
  scrollTextSections.forEach((scrollTextSection, index) => {
    // eslint-disable-next-line no-console
    console.log('[ScrollText][Runtime] Initializing instance', {
      index
    });
    ...
    switch (scrollDirection) {
      ...
      case 'right':
        ...
        fromProps = {
          xPercent: -50
        }; // This positions the right edge at the right edge of screen
        toProps = {
          xPercent: 50
        }; // This moves it right
        break;
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].fromTo(headline, fromProps, {
      ...toProps,
      ease: 'none',
      scrollTrigger: {
        trigger: scrollTextSection,
        // Use the specific section instance
        start: 'top top',
        end: `+=${scrollDistance}%`,
        scrub: animationSpeed,
        // Use animation speed for scrub value
        pin: true,
        pinSpacing: true,
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(scrollTextContent, {
      opacity: 0.3,
      // or your desired value
      ease: 'none',
      scrollTrigger: {
        trigger: scrollTextContent,
        // Use the specific content instance
        start: 'top top',
    ...
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__["default"].addEventListener("refresh", setPinSpacerHeight);
  });
});
})();
